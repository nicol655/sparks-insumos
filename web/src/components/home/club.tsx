  ...
  return (
    <section className="border-canvas/12 bg-ink text-canvas border-b">
      <div className="lg:grid lg:grid-cols-2">
        <div className="px-gutter py-section flex flex-col justify-center gap-6">
          <p className="font-mono text-[24px] leading-none tracking-[0.2em] text-accent-gold uppercase">
            {t("kicker")}
          </p>
          <h2 className="text-h2 font-display">{t("title")}</h2>
        ...
        <ol className="border-canvas/18 lg:border-l">
          {BENEFITS.map((key, index) => (
            ...
            >
              <span className="font-mono text-[24px] leading-none tracking-[0.12em] text-accent-gold">
